 ...
 <swiper 
    ...
    >
        ...
        <swiper-slide>
            ...
            <img class="absolute top-0 hidden transform translate-x-1/2 xl:block left-1/2" src="/src/assets/images/team/dots.svg" alt="">
    ...
    >
     ...
     <swiper-slide>
                <img class="block mx-auto mb-12" src="/src/assets/images/team/dots2.svg" alt="">
