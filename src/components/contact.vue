<template>
     <section id="contact" class="py-5 mb-10 overflow-hidden 2xl:pt-32 2xl:pb-36 bg-blueGray-100 rounded-b-10xl shadow-gray-900 drop-shadow-2xl">
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap items-center -mx-4">
            ...
            <div class="w-full px-4 lg:w-1/2">
              <h2  class="mb-6 font-medium text-9xl md:text-10xl xl:text-11xl font-heading">Contact</h2>
              <p class="text-lg mb-14 text-darkBlueGray-400">Get in touch</p>
